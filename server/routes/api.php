...
Route::get('order/stripe/stripeKey',[OrderApiController::class,'getStripeKey']);
Route::get('order/stripe/stripeSecret',[OrderApiController::class,'getStripeSecrets']);

Route::get('/cart/{token}',[CartApiController::class,'index']);
Route::post('/cart/{token}',[CartApiController::class,'store']);
Route::post('/cart/{id}/{token}',[CartApiController::class,'update']);
