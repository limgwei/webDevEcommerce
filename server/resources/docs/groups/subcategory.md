...
```bash
curl -X GET \
    -G "/api/subcategory/category/quidem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "/api/subcategory/category/quidem"
);
...
```bash
curl -X GET \
    -G "/api/subcategory/subcategory/enim" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "/api/subcategory/subcategory/enim"
);
