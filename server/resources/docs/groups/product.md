...
```bash
curl -X GET \
    -G "/api/product/sub/velit/latest" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "/api/product/sub/mollitia/name" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
