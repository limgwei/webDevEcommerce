...
```bash
curl -X DELETE \
    "http://localhost/api/product/nulla" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/api/promocode/odit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/promocode/odit"
);
...
```bash
curl -X PUT \
    "http://localhost/api/promocode/labore" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/api/promocode/sint" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/api/promocode-history/ipsa" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/promocode-history/ipsa"
);
...
```json
{
    "message": "SQLSTATE[42S02]: Base table or view not found: 1146 Table 'trytry.promo_code_histories' doesn't exist (SQL: select * from `promo_code_histories` where `id` = ipsa)",
    "exception": "Illuminate\\Database\\QueryException",
    "file": "C:\\Users\\HP\\Desktop\\laravel\\webDevEcommerce\\vendor\\laravel\\framework\\src\\Illuminate\\Database\\Connection.php",
    "line": 671,
    "trace": [
...
```bash
curl -X PUT \
    "http://localhost/api/promocode-history/deleniti" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/api/promocode-history/voluptatem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/api/sub-category/asperiores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/api/sub-category/fuga" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/api/user/quod" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/api/user/asperiores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
